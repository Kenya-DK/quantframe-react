...
use crate::{
    cache::{
        client::CacheClient,
        types::{cache_item_base::CacheItemBase, cache_item_component::CacheItemComponent, cache_melee::CacheMelee},
    },
    helper,
...
impl MeleeModule {
    ...
    pub fn get_by(&self, input: &str, by: &str) -> Result<Option<CacheMelee>, AppError> {
