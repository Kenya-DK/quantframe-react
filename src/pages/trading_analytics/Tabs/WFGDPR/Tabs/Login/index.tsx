...
export const LoginPanel = ({ isActive }: LoginPanelProps = {}) => {
  // States For DataGrid
  const queryData = useForm({
    initialValues: { page: 1, limit: 10, query: "" } as TauriTypes.WFGDPRLoginControllerGetListParams,
  });

  // Translate general
  const useTranslate = (key: string, context?: { [key: string]: any }, i18Key?: boolean) =>
    useTranslatePages(`trading_analytics.tabs.wfgdpr.login.${key}`, { ...context }, i18Key);
        ...
        columns={[
          {
            ...
            title: useTranslateColumns("client_type"),
            sortable: true,
          },
          {
            accessor: "ip",
            title: useTranslateColumns("ip"),
            sortable: true,
          },
          {
            accessor: "date",
