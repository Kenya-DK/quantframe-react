...
export type UpdateTransactionProps = {
	...
	onSubmit: (values: UpdateTransactionDto) => void;
}

export function UpdateTransaction({ value, onSubmit }: UpdateTransactionProps) {

	// Translate general
	const useTranslateForm = (key: string, context?: { [key: string]: any }, i18Key?: boolean) => useTranslateForms(`update_transaction.${key}`, { ...context }, i18Key)
