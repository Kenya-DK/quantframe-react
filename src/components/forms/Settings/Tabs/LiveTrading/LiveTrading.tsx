...
export const LiveTradingPanel = ({ onSubmit, value }: LiveTradingPanelProps) => {
  ...
  return (
    <Box h="100%">
      <form onSubmit={form.onSubmit(() => { onSubmit(form.values) })} style={{
        height: "100%",
        display: "flex",
            ...
            <Tabs.Panel value="riven" p="md">
              <Group gap="md">
                ...
                <NumberInput
                  ...
                  rightSection={<TooltipIcon label={useTranslateFormFields('threshold_percentage.tooltip', { value: form.values.stock_riven.threshold_percentage })} />}
                  suffix=" %"
                  radius="md"
                />
              </Group>
