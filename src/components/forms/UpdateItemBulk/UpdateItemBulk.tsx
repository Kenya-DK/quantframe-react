...
import { UpdateStockItem } from '@api/types';

export type UpdateItemBulkProps = {
	onSubmit: (values: UpdateStockItem) => void;
}

export function UpdateItemBulk({ onSubmit }: UpdateItemBulkProps) {

	// Translate general
	const useTranslateForm = (key: string, context?: { [key: string]: any }, i18Key?: boolean) => useTranslateForms(`update_stock_item.${key}`, { ...context }, i18Key)
