...
export function SplashScreen(props: SplashScreenProps) {
  ...
  return (
    <>
      {show && (
        <Center className={classes.splashScreen} data-show={!opened || undefined}>
          <svg
            version="1.1"
            style={{ fill: theme.other.logoColor }}
          ...
          >
            <g>
              <path
                d="M192.17,3.49c1.8,2.69,3.38,5.08,4.99,7.45c6.13,9.02,11.73,18.45,18.51,26.96c14.43,18.12,34.33,29.86,52.6,43.46
		...
		c23.96-15.73,42.74-36.42,56.77-61.43C191.08,4.71,191.46,4.37,192.17,3.49z"
              />
              <path
                d="M233.03,253.66c4.29,7.84,5.28,16.33,4.52,24.96c-0.39,4.33-1.68,8.64-3.05,12.79c-0.42,1.28-2.39,2.1-3.74,3
		...
		C232.35,254.21,232.69,253.93,233.03,253.66z"
              />
              <path
                d="M193.13,385.25c-56.85,0-113.71,0-170.56,0c-6.37,0-10.89-2.68-10.73-6.35c0.16-3.54,4.5-6.04,10.54-6.04
		...
		C306.84,385.26,249.99,385.25,193.13,385.25z"
              />
              <path
                d="M193.61,352.9c47.71,0,95.41,0,143.12,0c6.03,0,10.39,2.49,10.56,6.02c0.18,3.66-4.37,6.37-10.71,6.37
		...
		C97.54,352.9,145.58,352.9,193.61,352.9z"
              />
              <path
                d="M5.37,130.38c5.1-1.08,9.38-1.87,13.61-2.9c15.02-3.63,28.46-10.75,41.36-19c3.98-2.55,7.89-5.21,11.93-7.68
		...
		c-5.39-9.33-11.37-18.36-17.65-27.12C14.49,138.57,10.1,135.15,5.37,130.38z"
              />
              <path
                d="M378.14,129.42c-9.04,12.39-18.57,24.15-26.59,36.86c-7.16,11.35-12.65,23.75-18.86,35.69
		...
		c0.92-3.29,2.7-4.06,5.85-2.04c8.97,5.73,17.89,11.58,27.18,16.74C352.83,125.67,365.54,128.69,378.14,129.42z"
              />
              <path
                d="M193.06,332.94c36.73,0,73.46,0,110.18,0c5.6,0,9.9,2.55,10.11,5.96c0.22,3.56-4.28,6.42-10.16,6.42
		...
		z"
              />
              <path
                d="M211.72,108.82c-1,3.34-1.88,6.28-2.55,8.53c-6.32-0.58-12.25-1.61-18.14-1.41c-2.4,0.08-5.83,2.35-6.73,4.49
		...
		C206.33,105.85,208.98,107.7,211.72,108.82z"
              />
              <path
                d="M120.91,225.99c-8.41,1.17-17.51-3.98-21.71-12.04c-7.04-13.51-14.54-26.79-22.01-40.07c-2.16-3.83-4.91-7.33-7.66-11.37
		...
		c-8.01,5.49-8.1,5.6-3.58,14.7C101.71,198.03,108.67,213.46,120.91,225.99z"
              />
              <path
                d="M316.32,162.32c-4.13,5.83-8.75,11.54-12.49,17.78c-7.31,12.2-14.45,24.54-21.03,37.15c-3.44,6.59-9.71,5.97-15.8,7.54
		...
		c2.23-3.21,4.33-6.5,6.76-9.52c0.58-0.72,2.41-0.98,3.46-0.69C300.92,157.82,308.52,160.08,316.32,162.32z"
          ...
          {text && text != "" && (
            <Text className={classes.text} data-show={!opened || undefined} size="lg">
              {text}
            </Text>
          )}
        </Center>
