...
export function Clock() {
  ...
  // Translate general
  const useTranslateClock = (key: string, context?: { [key: string]: any }, i18Key?: boolean) =>
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const minutesUntilMidnight = Math.floor((timeUntilMidnightMS % 3600000) / 60000);
      const secondsUntilMidnight = Math.floor((timeUntilMidnightMS % 60000) / 1000);
