...
export function CreateStockItemForm({ hide_bought, disabled, boxProps, onSubmit }: CreateStockItemFormProps) {
  // Context States
  const { settings } = useAppContext();

  // Translate general
  const useTranslateForm = (key: string, context?: { [key: string]: any }, i18Key?: boolean) =>
    useTranslateForms(`create_stock_item.${key}`, { ...context }, i18Key);
