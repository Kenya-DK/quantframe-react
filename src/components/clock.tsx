...
export default function Clock() {
  ...
  return (
    <Group position="center" spacing="0px" display="flex" style={{ flexDirection: "column", }} >
      <Text color={theme.colors.gray[5]}>GMT: {currentTime}</Text>
      <Text color={theme.colors.gray[5]}>Time until midnight GMT: {timeUntilMidnight}</Text>
    </Group>
  );
}
