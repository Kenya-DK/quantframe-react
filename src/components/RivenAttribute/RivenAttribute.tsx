...
import { RivenAttribute } from '@api/types';
...
export function RivenAttributeCom({ value }: RivenAttributeComProps) {
  ...
  // Translate general
  const useTranslateRivenAttribute = (key: string, context?: { [key: string]: any }, i18Key?: boolean) => useTranslateComponent(`riven_attribute.${key}`, { ...context }, i18Key)
